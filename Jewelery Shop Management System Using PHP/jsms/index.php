...
<head>
	...
	<title>?Shah Jewellers || Home Page</title>
...
<body>
	...
	<div id="slider">
		<ul>
			<li style="background-image: url(images/1slide.jpeg)">
				<h3>Make your life better</h3>
				<h2>Genuine diamonds</h2>
			</li>
			<li class="purple" style="background-image: url(images/2slide.jpeg)">
				<h3>She will say “yes”</h3>
				<h2>engagement ring</h2>
			</li>
			<li class="yellow" style="background-image: url(images/3slide.jpeg)">
