...
?>
				...
				<div class="entry">
					<p><strong>Address: </strong><?php  echo $row[''];?>Juni main line, Choti Gujri, Pangari, Yavatmal-445001</p>
					<p><strong>Phone: </strong><?php  echo $row[''];?>7796000701</p>
					<p><strong>Email: </strong><?php  echo $row[''];?>shahjewellers@gmail.com</p>
